...
import imgAlfaparfSunshine from "../../assets/products/alfaparfblack.webp";
import imgCelimax from "../../assets/products/celimax.webp";
import imgAxisY from "../../assets/products/axisy.webp";
import imgBodyLotion from "../../assets/products/la_sultane_rose.jpg";
import imgHempz from "../../assets/products/hempz.jpg";
import imgAlthea from "../../assets/products/althea.avif";
...
import imgMargiela from "../../assets/products/margiela_perfume.jpg";
import imgLaneige from "../../assets/products/laneige_mask.jpg";
import imgDralteaSerum from "../../assets/products/draltea_serum.jpg";
import imgGlow from "../../assets/products/glow_recipe.jpg";
...
const TAB_PRODUCTS = [
    // Новинки
    [
        { id: 1, name: "ISNTREE Hyaluronic Acid Moist Cream", price: 750, img: imgIsntree },
        { id: 2, name: "PAULA'S CHOICE barrier repair moisturizer", price: 4700, img: imgPaula },
        { id: 3, name: "ALFAPARF SDL detoxifying low shampoo", price: 1700, img: imgAlfaparf },
        { id: 4, name: "CELIMAX CICA CREAM", price: 750, img: imgCelimax },
        { id: 5, name: "ALFAPARF SDL sunshine after sun low shampoo", price: 1200, img: imgAlfaparfSunshine },
        { id: 6, name: "AXIS-Y complete no-stress physical sunscreen", price: 1050, img: imgAxisY },
        { id: 7, name: "LA SULTANE DE SABA rose body lotion", price: 4700, img: imgBodyLotion },
        { id: 8, name: "HEMPZ body moisturizer coconut Colada&Pineapple", price: 3490, img: imgHempz },
    ],
    // Бестселлеры
    [
        { id: 11, name: "Beauty of Joseon Relief Sun SPF 50+", price: 1100, img: imgBojSun },
        { id: 12, name: "DR.ALTHEA double serum balm foundation", price: 1500, img: IMG_DR_ALTHEA },
        { id: 13, name: "GLOW RECIPE watermelon glow toner", price: 2100, img: imgGlow },
        { id: 14, name: "RARE BEAUTY soft pinch tinted lip oil", price: 2400, img: imgRare },
        { id: 15, name: "LANEIGE lip sleeping mask", price: 1350, img: imgLaneige },
        { id: 16, name: "SOL DE JANEIRO Cheirosa 62 Perfume Mist", price: 2700, img: imgSdjFragrance },
        { id: 17, name: "MOROCCANOIL treatment oil", price: 2800, img: imgMoroccanoil },
        { id: 18, name: "ISNTREE Hyaluronic Acid Moist Cream", price: 750, img: imgIsntree },
    ],
    // Рекомендуемое
    [
        { id: 21, name: "BYREDO parfums bal d'afrique", price: 8900, img: imgByredo },
        { id: 22, name: "MAISON MARGIELA replica beach walk", price: 7200, img: imgMargiela },
        { id: 23, name: "ALFAPARF SDL sunshine after sun low shampoo", price: 1200, img: imgAlfaparfSunshine },
        { id: 24, name: "LANEIGE lip sleeping mask", price: 1350, img: imgLaneige },
        { id: 25, name: "DR. ALTHEA Royal Jelly Barrier Cream", price: 1800, img: imgAlthea },
        { id: 26, name: "DR. ALTHEA Pore Tightening Serum", price: 2300, img: imgDralteaSerum },
        { id: 27, name: "GLOW RECIPE watermelon glow toner", price: 2950, img: imgGlow },
        { id: 28, name: "PAULA'S CHOICE barrier repair moisturizer", price: 4700, img: imgPaula },
    ],
];
